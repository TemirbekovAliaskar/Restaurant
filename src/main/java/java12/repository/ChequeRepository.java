...
public interface ChequeRepository extends JpaRepository<Cheque, Long> {
    ...
    @Query("select  new java12.dto.response.ChequeResponse(u.firstName,c.priceTotal,c.service,c.procient,c.createdAt) from Cheque  c join c.user u where c.id =:checkId")
